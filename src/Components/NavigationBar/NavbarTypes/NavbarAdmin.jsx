...
function NavbarAdmin() {
    ...
    const navigation = [
        ...
        { name: 'Startup', href: '/Startups', current: false },
        { name: 'Demande Utilisateurs ', href: '/demande', current: false },
        { name: 'Calendrier ', href: '/Calendar', current: false },
        { name: 'Courrier', href: '/courrier', current: false },
        { name: 'Tutoriel', href: '/tutorial', current: false },
        { name: 'Visioconférence', href: '/call', current: false },
        { name: 'Autre Service', href: '/autre', current: false },
    ]
